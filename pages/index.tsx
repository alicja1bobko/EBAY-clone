...
import { ContractPrimarySale, ListingType } from "@thirdweb-dev/sdk";
        ...
        {loadingListings ? (
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-5 mx-auto">
            {listings?.map((listing) => (
              <div
                className="flex flex-col card p-4 hover:scale-105 transition-all duration-150 ease-out"
                key={listing.id}
              >
                ...
                <div className="pt-2 space-y-4">
                  <div>
                    ...
                    <hr />
                    <p className="truncate text-sm text-gray-600 mr-2">
