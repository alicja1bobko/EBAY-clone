  ...
  return (
    <div>
      ...
      <main className="max-w-6xl mx-auto p-10 border">
        ...
        <h2 className="text-xl font-bold pt-5">Item Details</h2>
        <p className="pb-5">
          By adding an item to the Marketplace, you-re essentially Minting an
          NFT of the item into your wallet when we can then list for sale!
        </p>
        <div className="flex flex-col justify-center items-center md:flex-row md:space-x-5 pt-5">
          ...
          >
            ...
            <button
              type="submit"
              className="bg-blue-600 text-white rounded-full py-4 px-10 w-56 md:first-letter:mt-auto mx-auto md:ml-auto"
            >
              Add/Mint Item
            </button>
          </form>
